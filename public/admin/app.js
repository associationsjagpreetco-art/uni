...
function navigate(page) {
  ...
  const titles = { overview:'Overview', orders:'Orders', revenue:'Revenue', profit:'Profit', discount:'Discount Codes', support:'Customer Support' };
  const subs   = { overview:'Welcome back, Admin! Here\'s what\'s happening.', orders:'Manage and track all orders', revenue:'Revenue analytics and trends', profit:'Profit breakdown and analysis', discount:'Manage discount codes', support:'Customer requests and messages' };
  document.getElementById('page-title').textContent = titles[page];
  document.getElementById('page-sub').textContent = subs[page];
  const renderers = { overview:renderOverview, orders:renderOrders, revenue:renderRevenue, profit:renderProfit, discount:renderDiscount, support:renderSupport };
